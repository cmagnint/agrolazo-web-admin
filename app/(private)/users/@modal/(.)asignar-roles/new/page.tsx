...
export default async function NewUserRoleModalPage() {
  const [users, roles] = await Promise.all([getUsers(), getRoles()]);

  return (
    <InterceptedModal title="Nueva asignación de rol">
      <div className="mx-auto max-w-4xl space-y-6">
        <section aria-labelledby="new-user-role-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Asignaciones</p>
          <h1 id="new-user-role-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
