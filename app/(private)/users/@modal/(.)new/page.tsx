...
export default function NewUserModalPage() {
  return (
    <InterceptedModal title="Nuevo usuario">
      <div className="mx-auto max-w-4xl space-y-6">
        <section aria-labelledby="new-user-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Usuarios</p>
          <h1 id="new-user-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
            Nuevo usuario
          </h1>
