...
type EditPermissionModalPageProps = {
  params: Promise<{
    id: string;
  }>;
};

export default async function EditPermissionModalPage({ params }: EditPermissionModalPageProps) {
  ...
  return (
    <InterceptedModal title="Editar permiso">
      <div className="mx-auto max-w-4xl space-y-6">
        <section aria-labelledby="edit-permission-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Permisos</p>
          <h1 id="edit-permission-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
            Editar permiso
          </h1>
