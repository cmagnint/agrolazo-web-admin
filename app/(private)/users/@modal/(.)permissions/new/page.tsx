...
export default function NewPermissionModalPage() {
  return (
    <InterceptedModal title="Nuevo permiso">
      <div className="mx-auto max-w-4xl space-y-6">
        <section aria-labelledby="new-permission-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Permisos</p>
          <h1 id="new-permission-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
            Nuevo permiso
          </h1>
