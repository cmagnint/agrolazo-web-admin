...
export default function NewRoleModalPage() {
  return (
    <InterceptedModal title="Nuevo rol">
      <div className="mx-auto max-w-4xl space-y-6">
        <section aria-labelledby="new-role-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Roles</p>
          <h1 id="new-role-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
            Nuevo rol
          </h1>
