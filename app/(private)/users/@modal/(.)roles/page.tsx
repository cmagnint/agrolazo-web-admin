...
export default async function RolesModalPage() {
  const roles = await getRoles();

  return (
    <InterceptedModal title="Gestionar roles">
      <div className="mx-auto max-w-6xl space-y-6">
        <section aria-labelledby="roles-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Usuarios</p>
          <h1 id="roles-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
            Gestionar roles
          </h1>
