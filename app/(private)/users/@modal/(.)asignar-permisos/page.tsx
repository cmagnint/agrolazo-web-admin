...
export default async function RolePermissionsModalPage() {
  const rows = await getRolePermissionRelations();

  return (
    <InterceptedModal title="Asignaciones de permiso">
      <div className="mx-auto max-w-6xl space-y-6">
        <section aria-labelledby="role-permissions-modal-title">
          <p className="text-sm font-semibold text-[var(--color-primary)]">Usuarios</p>
          <h1 id="role-permissions-modal-title" className="mt-2 text-3xl font-bold tracking-normal">
